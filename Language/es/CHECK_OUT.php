...
define('SHOW_CART','Mostrar Carrito');
define('GALLERY_VIEW','Galeria');
define('PRODUCT_NAME','Nombre del Producto');
define('QUANTITY','Ctda.');
...
define('SIGN_UP_FOR_AN_ACCOUNT','INGRESE PARA UNA CUENTA');
...
//messages
define('NO_PRODUCTS_AVAILABLE_IN_YOUR_CART','No hay productos disponibles en su carrito.');
define('PRODUCTS_DELETED_SUCCESSFULLY_FROM_YOUR_CART','El producto fue borrado de su carrito satisfactoriamente!');
