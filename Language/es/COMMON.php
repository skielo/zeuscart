...
define('SHOPPING_CART','Carrito de compras');
define('ITEMS','Items');
define('ITEMS_FOUND','Items Encontrados');
define('HOME','Home');
...
define('REGISTER_HERE','Registrese aqui');
define('ADD_NEW_CONTACT','Agregar nuevo contacto');
define('EDIT','Editar');
define('DEL','Borrar');
define('CANCEL','Cancelar');
define('GO','Ir');
define('ADD_TO_CART','AGREGAR AL CARRITO');
define('ADD_TO_WISHLIST','AGREGAR A LISTA DE DESEOS');
define('CLICK_TO_SELECT','CLICK PARA SELECCIONAR');
define('OR','O');
...
define('ABOUT_US','Acerca de Nosotros');
define('PRIVACY_POLICY','Politicas de Privacidad');
define('TERMS_&_CONDITIONS','Terminos & Condiciones');
define('FAQ','FAQ');
define('LATEST_NEWS','Ultimas Noticias');
define('CONTACT_US','Contactenos');
define('SITE_MAP','Mapa del sitio');
define('WISH_LIST','Lista de deseos');
define('BRANDS','Marcas');
define('GIFT_VOUCHRES','Vouchers de regalo');
...
define('INVALID_EMAIL','Email invalido');
define('INVALID_PASWORD','Password invalido');
...
define('PASSWORD_MISMATCH','El Password no coincide');
...
define('NO_MAIL_ID_PROVIDED','No ingreso un Email ID');
